...
TRANSLATIONS = {
    "en": {
        ...
        # ---- tycoon: business ----
        "biz_gold_label": "GOLD  -  buy",
        "biz_cash_label": "CASH  +{rate}/s",
        "biz_next": "Next: {name}",
        "biz_next_at": "at {cash} cash earned",
        "biz_all_owned": "All businesses owned",
        "biz_keep_growing": "Keep collecting to grow",
        ...
        "biz_locked": "Locked - earn {cash} cash",
        "biz_owned_info": "Lv {level}  -  +{profit} cash / {cycle}s",
        "biz_unowned_info": "+{profit} cash / {cycle}s",
        "business_lemonade": "Lemonade Stand",
        "business_foodtruck": "Food Truck",
        "business_cafe": "Cafe",
        "business_workshop": "Workshop",
        "business_factory": "Factory",
    ...
    "de": {
        ...
        # ---- tycoon: business ----
        "biz_gold_label": "GOLD  -  kaufen",
        "biz_cash_label": "BARGELD  +{rate}/s",
        "biz_next": "Naechstes: {name}",
        "biz_next_at": "bei {cash} Bargeld verdient",
        "biz_all_owned": "Alle Betriebe gekauft",
        "biz_keep_growing": "Sammle weiter, um zu wachsen",
        ...
        "biz_locked": "Frei ab {cash} Bargeld",
        "biz_owned_info": "Stufe {level}  -  +{profit} Bargeld / {cycle}s",
        "biz_unowned_info": "+{profit} Bargeld / {cycle}s",
        "business_lemonade": "Limonadenstand",
        "business_foodtruck": "Foodtruck",
        "business_cafe": "Cafe",
        "business_workshop": "Werkstatt",
        "business_factory": "Fabrik",
        "business_franchise": "Franchise",
    },
}
